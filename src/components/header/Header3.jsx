...
import KeyboardArrowRightOutlinedIcon from "@mui/icons-material/KeyboardArrowRight";
import {
      ...
      >
        ...
        >
          ...
          {[
            ...
            { mainlink: "User Accpunt", sublink: ["Link1", "Link2", "Link3"] },
            {
              mainlink: "Vender Acoount",
              sublink: ["Link1", "Link2", "Link3"],
            },
          ].map((item) => {
            return (
