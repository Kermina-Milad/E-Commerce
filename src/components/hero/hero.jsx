...
const mySlider=[
    {text:"MEN", link:"./HeroImages/banner-15.jpg",},
    {text:"WOMEN", link:"./HeroImages/banner-25.jpg",}
]
...
Shop Now
      ...
      <Box sx={{ display: { xs: "none", md: "block", minWidth:"26.6%" } }}>
        <Box sx={{ position: "relative" }}>
          <img  width={"100%"} src=".\HeroImages\banner-17.jpg" alt="" />
          <Stack
            sx={{
              position: "absolute",
              top: "50%",
        ...
        <Box sx={{ position: "relative" }}>
          <img width={"100%"} src=".\HeroImages\banner-16.jpg" alt="" />
          <Stack
            sx={{
              position: "absolute",
              top: "50%",
